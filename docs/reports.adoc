...
If you are running smart testing in debug mode using property `const:core/src/main/java/org/arquillian/smart/testing/configuration/Configuration.java[name="SMART_TESTING_DEBUG"]` or in maven debug output mode using `-X` or `--debug` then Smart Testing will generate report.
