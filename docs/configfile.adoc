...
<11> This defines list of strategies with it's configuration that you want to apply while applying strategy.
<12> This gives a location for properties file containing inclusions & exclusions.
<13> This enables transitivity.
<14> This defines list packages to be excluded while applying transitivity.
<15> This defines list of packaged to be included while applying transitivity.
...
|Field | Description
a| config
a| Sets location for properties file containing inclusions & exclusions.
