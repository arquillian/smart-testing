...
public class DebugModeSmartTestingFunctionalTest {
    ...
    @Test
    public void should_show_debug_logs_and_generate_report_when_smart_testing_is_executed_in_debug_mode() throws Exception {
        // given
        ...
        final String baseDir = project.getRoot().toFile() + "/config/impl-base";
        assertThat(new LocalStorage(baseDir).afterExecution().toReporting().file(REPORT_FILE_NAME).getFile()).isFile().exists();
    }
